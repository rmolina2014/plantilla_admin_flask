...
def buscar_alerta():
    ...
    for data in datos:
        ...
        if (sensor_1_fuego == valortrue):
            print("alerta")
            item = {'id': idi, 'ubicacion': ubicacion_id, 'sensor': 'Fuego','fechahora': fecha_hora, 'alerta': 'danger', 'nombre_ubicacion': nombre_ubicacion}
            json.append(item)
        else:
            print("normal")
            item = {'id': idi, 'ubicacion': ubicacion_id, 'sensor': 'Fuego','fechahora': fecha_hora, 'alerta': 'success', 'nombre_ubicacion': nombre_ubicacion}
            json.append(item)
        # 2 de temperatura , 3 de movimiento , 4 de humedad
        if (sensor_8_temperatura >= 30):
            print("alerta")
            item = {'id': idi, 'ubicacion': ubicacion_id, 'sensor': 'Temperatura','fechahora': fecha_hora, 'alerta': 'warning', 'nombre_ubicacion': nombre_ubicacion}
            json.append(item)
        else:
            print("normal")
            item = {'id': idi, 'ubicacion': ubicacion_id, 'sensor': 'Temperatura','fechahora': fecha_hora, 'alerta': 'success', 'nombre_ubicacion': nombre_ubicacion}
            json.append(item)

        # 3 de movimiento ,Sensor Detector Movimiento Infrarrojo Sr501 - 5
        if (sensor_5_movimiento == valortrue):
            print("alerta")
            item = {'id': idi, 'ubicacion': ubicacion_id, 'sensor': 'Movimiento','fechahora': fecha_hora, 'alerta': 'warning', 'nombre_ubicacion': nombre_ubicacion}
            json.append(item)
        else:
            print("normal")
            item = {'id': idi, 'ubicacion': ubicacion_id, 'sensor': 'Movimiento','fechahora': fecha_hora, 'alerta': 'success', 'nombre_ubicacion': nombre_ubicacion}
            json.append(item)

        # 4 de humedad, Sensor De Humedad Y Temperatura Dht22 - 4
        if (sensor_4_humedad >= 90):
            print("alerta")
            item = {'id': idi, 'ubicacion': ubicacion_id, 'sensor': 'Humedad','fechahora': fecha_hora, 'alerta': 'warning', 'nombre_ubicacion': nombre_ubicacion}
            json.append(item)
        else:
            print("normal")
            item = {'id': idi, 'ubicacion': ubicacion_id, 'sensor': 'Humedad','fechahora': fecha_hora, 'alerta': 'success', 'nombre_ubicacion': nombre_ubicacion}
            json.append(item)
